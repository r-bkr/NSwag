...
namespace PetStore
{
    ...
    public partial class PetStoreClient : IPetStoreClient
    {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        protected virtual System.Threading.Tasks.Task AddPetCoreAsync(Pet body)
        {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        protected virtual async System.Threading.Tasks.Task AddPetCoreAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.21.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v11.0.0.0))")]
