...
export class GeoClient {
    ...
    fromBodyTest(location: GeoPoint | null | undefined) {
        return new Promise<void>((resolve, reject) => {
            this.fromBodyTestWithCallbacks(location, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private fromBodyTestWithCallbacks(location: GeoPoint | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    addPolygon(points: GeoPoint[] | null | undefined) {
        return new Promise<void>((resolve, reject) => {
            this.addPolygonWithCallbacks(points, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private addPolygonWithCallbacks(points: GeoPoint[] | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    saveItems(request: GenericRequestOfAddressAndPerson | null | undefined) {
        return new Promise<void>((resolve, reject) => {
            this.saveItemsWithCallbacks(request, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private saveItemsWithCallbacks(request: GenericRequestOfAddressAndPerson | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: Exception | string, reason: string) => void) {
...
export class PersonsClient {
    ...
    add(person: Person | null | undefined) {
        return new Promise<void>((resolve, reject) => {
            this.addWithCallbacks(person, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private addWithCallbacks(person: Person | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: string, reason: string) => void) {
        let url_ = this.baseUrl + "/api/Persons";
        url_ = url_.replace(/[?&]$/, "");
    ...
    transform(person: Person | null | undefined) {
        return new Promise<Person | null>((resolve, reject) => {
            this.transformWithCallbacks(person, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private transformWithCallbacks(person: Person | null | undefined, onSuccess?: (result: Person | null) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    addXml(person: string | null | undefined) {
        return new Promise<string | null>((resolve, reject) => {
            this.addXmlWithCallbacks(person, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private addXmlWithCallbacks(person: string | null | undefined, onSuccess?: (result: string | null) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    upload(data: Blob | null | undefined) {
        return new Promise<string | null>((resolve, reject) => {
            this.uploadWithCallbacks(data, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private uploadWithCallbacks(data: Blob | null | undefined, onSuccess?: (result: string | null) => void, onFail?: (exception: string, reason: string) => void) {
...
export class GeoPoint {
    ...
    init(data?: any) {
        if (data !== undefined) {
            var latitude_: any;
                latitude_ = _data["Latitude"];
            this.latitude(latitude_);

            var longitude_: any;
                longitude_ = _data["Longitude"];
...
export class Exception {
    ...
    init(data?: any) {
        if (data !== undefined) {
            ...
            innerException_ = _data["InnerException"] ? Exception.fromJS(_data["InnerException"]) : <any>undefined;
            this.innerException(innerException_);

            var stackTrace_: any;
                stackTrace_ = _data["StackTrace"];
            this.stackTrace(stackTrace_);

            var source_: any;
                source_ = _data["Source"];
            this.source(source_);
...
export class GenericRequestOfAddressAndPerson {
    ...
    init(data?: any) {
        if (data !== undefined) {
            var item1_: any;
            item1_ = _data["Item1"] ? Address.fromJS(_data["Item1"]) : <any>undefined;
            this.item1(item1_);

            var item2_: any;
            item2_ = _data["Item2"] ? Person.fromJS(_data["Item2"]) : <any>undefined;
            this.item2(item2_);
    ...
    init(data?: any) {
        if (data !== undefined) {
            ...
            var averageSleepTime_: any;
                averageSleepTime_ = _data["AverageSleepTime"];
            this.averageSleepTime(averageSleepTime_);

            var address_: any;
            address_ = _data["Address"] ? Address.fromJS(_data["Address"]) : new Address();
            ...
            if (_data["Skills"]) {
                ...
                for (let key in _data["Skills"]) {
                    if (_data["Skills"].hasOwnProperty(key))
                        (<any>skills_)[key] = _data["Skills"][key];
                }
            }
            this.skills(skills_);
        ...
        if (skills_) {
            ...
            for (let key in skills_) {
                if (skills_.hasOwnProperty(key))
                    (<any>data["Skills"])[key] = (<any>skills_)[key];
            }
        }
...
export class Teacher extends Person {
    ...
    init(data?: any) {
        ...
        if (data !== undefined) {
            var course_: any;
                course_ = _data["Course"];
            this.course(course_);

            var skillLevel_: any;
                skillLevel_ = _data["SkillLevel"] !== undefined ? _data["SkillLevel"] : SkillLevel.Medium;
