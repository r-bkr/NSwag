...
export class Client {
     ...
     * @param start_latitude Latitude component of start location.
     * @param start_longitude Longitude component of start location.
     * @param customer_uuid (optional) Unique customer identifier to be used for experience customization.
     * @param product_id (optional) Unique identifier representing a specific product for a given latitude & longitude.
     * @return An array of products
     */
    time(start_latitude: number, start_longitude: number, customer_uuid: string | null | undefined, product_id: string | null | undefined): Promise<Product[]> {
        ...
        if (start_longitude === undefined || start_longitude === null)
            ...
            url_ += "start_longitude=" + encodeURIComponent("" + start_longitude) + "&";
        if (customer_uuid !== undefined && customer_uuid !== null)
    ...
    /**
     * User Activity
     * @param offset (optional) Offset the list of returned results by this amount. Default is zero.
     * @param limit (optional) Number of items to retrieve. Default is 5, maximum is 100.
...
export class PriceEstimate implements IPriceEstimate {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.low_estimate = _data["low_estimate"];
            this.high_estimate = _data["high_estimate"];
            this.surge_multiplier = _data["surge_multiplier"];
        }
    }
...
export class Profile implements IProfile {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.promo_code = _data["promo_code"];
        }
    }
