...
export class GeoClient extends MyBaseClass {
    ...
    fromBodyTest(location?: GeoPoint | null | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processFromBodyTest(r as any));
    ...
    protected processFromBodyTest(response: HttpResponseBase): Observable<void> {
    ...
    fromUriTest(latitude?: number | undefined, longitude?: number | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processFromUriTest(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processFromUriTest(r as any));
    ...
    protected processFromUriTest(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    addPolygon(points?: GeoPoint[] | null | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processAddPolygon(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processAddPolygon(r as any));
    ...
    protected processAddPolygon(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    filter(currentStates?: string[] | null | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processFilter(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processFilter(r as any));
    ...
    protected processFilter(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    reverse(values?: string[] | null | undefined): Observable<string[] | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processReverse(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processReverse(r as any));
    ...
    protected processReverse(response: HttpResponseBase): Observable<string[] | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    refresh(): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processRefresh(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processRefresh(r as any));
    ...
    uploadFile(file?: FileParameter | null | undefined): Observable<boolean> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processUploadFile(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processUploadFile(r as any));
    ...
    uploadFiles(files?: FileParameter[] | null | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processUploadFiles(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processUploadFiles(r as any));
    ...
    saveItems(request?: GenericRequestOfAddressAndPerson | null | undefined): Observable<void> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processSaveItems(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processSaveItems(r as any));
    ...
    protected processSaveItems(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 204) {
            ...
            result450 = Exception.fromJS(resultData450, _mappings);
    ...
    getUploadedFile(id: number, override?: boolean | undefined): Observable<FileResponse | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processGetUploadedFile(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processGetUploadedFile(r as any));
    ...
    protected processGetUploadedFile(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    postDouble(value?: number | null | undefined): Observable<number | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processPostDouble(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processPostDouble(r as any));
    ...
    protected processPostDouble(response: HttpResponseBase): Observable<number | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PersonsClient extends MyBaseClass {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<Person[] | null>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Person[] | null>;
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<Person[] | null> {
        ...
        return _observableOf<Person[] | null>(null as any);
    }

    add(person?: Person | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Persons";
        url_ = url_.replace(/[?&]$/, "");
    ...
    find(gender: Gender): Observable<Person[] | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processFind(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processFind(r as any));
    ...
    protected processFind(response: HttpResponseBase): Observable<Person[] | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    findOptional(gender: Gender | null): Observable<Person[] | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processFindOptional(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processFindOptional(r as any));
    ...
    protected processFindOptional(response: HttpResponseBase): Observable<Person[] | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processGet(response: HttpResponseBase): Observable<Person | null> {
        ...
        if (status === 500) {
            ...
            result500 = PersonNotFoundException.fromJS(resultData500, _mappings);
    ...
    transform(person?: Person | null | undefined): Observable<Person | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processTransform(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processTransform(r as any));
    ...
    protected processTransform(response: HttpResponseBase): Observable<Person | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    throw(id: string): Observable<Person> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processThrow(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processThrow(r as any));
    ...
    protected processThrow(response: HttpResponseBase): Observable<Person> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : jsonParse(_responseText, this.jsonParseReviver);
            result200 = Person.fromJS(resultData200, _mappings);
            return _observableOf(result200);
            }));
        } else if (status === 500) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Person>(null as any);
    }
    ...
    getName(id: string): Observable<string> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processGetName(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processGetName(r as any));
    ...
    addXml(person?: string | null | undefined): Observable<string | null> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            return this.transformResult(url_, response_, (r) => this.processAddXml(r as any));
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.transformResult(url_, response_, (r) => this.processAddXml(r as any));
    ...
    protected processAddXml(response: HttpResponseBase): Observable<string | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    upload(data?: Blob | null | undefined): Observable<string | null> {
    ...
    protected processUpload(response: HttpResponseBase): Observable<string | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GeoPoint implements IGeoPoint {
    ...
    static fromJS(data: any, _mappings?: any): GeoPoint | null {
...
export class GenericRequestOfAddressAndPerson implements IGenericRequestOfAddressAndPerson {
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            this.item1 = _data["Item1"] ? Address.fromJS(_data["Item1"], _mappings) : <any>undefined;
            this.item2 = _data["Item2"] ? Person.fromJS(_data["Item2"], _mappings) : <any>undefined;
        }
    }

    static fromJS(data: any, _mappings?: any): GenericRequestOfAddressAndPerson | null {
        data = typeof data === 'object' ? data : {};
...
export class Address implements IAddress {
    ...
    static fromJS(data: any, _mappings?: any): Address | null {
        data = typeof data === 'object' ? data : {};
...
export class Person implements IPerson {
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            ...
            this.address = _data["Address"] ? Address.fromJS(_data["Address"], _mappings) : new Address();
    ...
    static fromJS(data: any, _mappings?: any): Person | null {
        data = typeof data === 'object' ? data : {};
        ...
        if (this.skills) {
            ...
            for (let key in this.skills) {
                if (this.skills.hasOwnProperty(key))
                    (<any>data["Skills"])[key] = (<any>this.skills)[key];
            }
        }
        return data;
    }
...
export class Teacher extends Person implements ITeacher {
    ...
    static fromJS(data: any, _mappings?: any): Teacher | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<Teacher>(data, _mappings, Teacher);
    }
...
export class PersonNotFoundException extends Exception implements IPersonNotFoundException {
    ...
    static fromJS(data: any, _mappings?: any): PersonNotFoundException | null {
        data = typeof data === 'object' ? data : {};
